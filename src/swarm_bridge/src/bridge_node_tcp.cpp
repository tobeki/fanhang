...
void goal_sub_cb(const mars_quadrotor_msgs::GoalSetPtr &msg)
{
...
void goal_exploration_sub_cb(const mars_quadrotor_msgs::GoalSetPtr &msg)
{
...
{
  mars_quadrotor_msgs::GoalSet goal_msg_;
...
int main(int argc, char **argv)
{
  ...
  goal_pub_ = nh.advertise<mars_quadrotor_msgs::GoalSet>("/goal_brig2plner", 100);
  ...
  // goal_exploration_pub_ = nh.advertise<mars_quadrotor_msgs::GoalSet>("/goal_with_id_to_planner", 100);
