"""autogenerated by genpy from mars_quadrotor_msgs/Serial.msg. Do not edit."""
import sys
...
class Serial(genpy.Message):
  ...
  _type = "mars_quadrotor_msgs/Serial"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Note: These constants need to be kept in sync with the types
# defined in include/mars_quadrotor_msgs/comm_types.h
